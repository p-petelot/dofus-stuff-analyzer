...
const SLOT_REQUESTS: Record<SlotKey, SlotRequestConfig[]> = {
  ...
  familier: [
    { typeIds: [18, 97, 121, 196, 207, 249, 250], skip: 0, limit: 1600 },
  ],
  epauliere: [{ typeIds: [299], skip: 0, limit: 800 }],
  costume: [{ typeIds: [199], skip: 0, limit: 800 }],
  ailes: [{ typeIds: [300], skip: 0, limit: 800 }],
};
...
async function fetchItemsForSlot(slot: SlotKey, language = DEFAULT_LANGUAGE): Promise<ItemMeta[]> {
