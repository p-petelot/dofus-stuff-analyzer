...
const TRANSLATIONS = {
  fr: {
    ...
    "tabs.navigation": "Navigation principale",
    "tabs.analyzer": "Analyse",
    "tabs.gallery": "Galerie",
    "gallery.title": "Galerie de skins",
    "gallery.subtitle":
      "Découvre des compositions générées automatiquement à partir du catalogue Dofus.",
    "gallery.shuffle": "Nouveaux skins aléatoires",
    "gallery.countLabel": "Nombre de skins",
    "gallery.countOption": "{count} skins",
    "gallery.loading": "Génération des skins en cours…",
    "gallery.empty": "Aucune proposition disponible pour le moment.",
    "gallery.card.generation": "Skin n°{index}",
    "gallery.card.items": "Équipement du skin",
    "gallery.card.palette": "Palette utilisée",
    "gallery.card.copyPalette": "Copier {hex}",
    "gallery.card.downloadPreview": "Télécharger le rendu",
    "gallery.card.openBarbofus": "Tester sur Barbofus",
    "gallery.card.openSouff": "Voir sur Skin Souff",
  ...
  en: {
    ...
    "tabs.analyzer": "Analyzer",
    "tabs.gallery": "Gallery",
    "gallery.title": "Skin gallery",
    "gallery.subtitle":
      "Browse randomly generated Dofus skins curated from the catalog.",
    "gallery.shuffle": "Generate new skins",
    "gallery.countLabel": "Skin count",
    "gallery.countOption": "{count} skins",
    "gallery.loading": "Generating skins…",
    "gallery.empty": "No skin available yet.",
    "gallery.card.generation": "Skin #{index}",
    "gallery.card.items": "Skin equipment",
    "gallery.card.palette": "Palette",
    "gallery.card.copyPalette": "Copy {hex}",
    "gallery.card.downloadPreview": "Download preview",
    "gallery.card.openBarbofus": "Try on Barbofus",
    "gallery.card.openSouff": "View on Skin Souff",
  ...
  es: {
    ...
    "tabs.navigation": "Navegación principal",
    "tabs.analyzer": "Análisis",
    "tabs.gallery": "Galería",
    "gallery.title": "Galería de skins",
    "gallery.subtitle":
      "Explora combinaciones generadas automáticamente a partir del catálogo de Dofus.",
    "gallery.shuffle": "Nuevos skins aleatorios",
    "gallery.countLabel": "Número de skins",
    "gallery.countOption": "{count} skins",
    "gallery.loading": "Generando skins…",
    "gallery.empty": "No hay propuestas disponibles por ahora.",
    "gallery.card.generation": "Skin n.º {index}",
    "gallery.card.items": "Equipamiento del skin",
    "gallery.card.palette": "Paleta utilizada",
    "gallery.card.copyPalette": "Copiar {hex}",
    "gallery.card.downloadPreview": "Descargar la vista previa",
    "gallery.card.openBarbofus": "Probar en Barbofus",
    "gallery.card.openSouff": "Ver en Skin Souff",
  ...
  de: {
    ...
    "theme.option.dofus": "Dofus",
    "theme.option.intelligent": "Intelligent",
    "tabs.navigation": "Hauptnavigation",
    "tabs.analyzer": "Analyse",
    "tabs.gallery": "Galerie",
    "gallery.title": "Skin-Galerie",
    "gallery.subtitle":
      "Entdecke automatisch generierte Dofus-Skins aus dem Katalog.",
    "gallery.shuffle": "Neue zufällige Skins",
    "gallery.countLabel": "Anzahl der Skins",
    "gallery.countOption": "{count} Skins",
    "gallery.loading": "Skins werden erzeugt…",
    "gallery.empty": "Derzeit sind keine Vorschläge verfügbar.",
    "gallery.card.generation": "Skin Nr. {index}",
    "gallery.card.items": "Ausrüstung des Skins",
    "gallery.card.palette": "Verwendete Palette",
    "gallery.card.copyPalette": "{hex} kopieren",
    "gallery.card.downloadPreview": "Vorschau herunterladen",
    "gallery.card.openBarbofus": "In Barbofus testen",
    "gallery.card.openSouff": "Auf Skin Souff ansehen",
  ...
  pt: {
    ...
    "theme.option.dofus": "Dofus",
    "theme.option.intelligent": "Inteligente",
    "tabs.navigation": "Navegação principal",
    "tabs.analyzer": "Análise",
    "tabs.gallery": "Galeria",
    "gallery.title": "Galeria de skins",
    "gallery.subtitle":
      "Explora composições geradas automaticamente a partir do catálogo de Dofus.",
    "gallery.shuffle": "Novas skins aleatórias",
    "gallery.countLabel": "Quantidade de skins",
    "gallery.countOption": "{count} skins",
    "gallery.loading": "Gerando skins…",
    "gallery.empty": "Nenhuma proposta disponível no momento.",
    "gallery.card.generation": "Skin nº {index}",
    "gallery.card.items": "Equipamentos do skin",
    "gallery.card.palette": "Paleta utilizada",
    "gallery.card.copyPalette": "Copiar {hex}",
    "gallery.card.downloadPreview": "Baixar a pré-visualização",
    "gallery.card.openBarbofus": "Testar no Barbofus",
    "gallery.card.openSouff": "Ver no Skin Souff",
