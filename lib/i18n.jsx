...
const TRANSLATIONS = {
  fr: {
    "brand.tagline": "La palette intelligente pour imaginer tes skins Dofus.",
    "meta.description":
      "KrosPalette extrait les couleurs dominantes de tes images pour composer des skins Dofus harmonieux.",
    "header.themeMenuLabel": "Modifier le thème",
    "header.languageMenuLabel": "Changer la langue",
    "header.themeMenuTitle": "Thème",
    "header.languageMenuTitle": "Langue",
    "navigation.primary": "Navigation principale",
    "navigation.workspace": "Atelier",
  ...
  en: {
    "brand.tagline": "The smart palette to imagine your Dofus looks.",
    "meta.description":
      "KrosPalette extracts the dominant colors from your images to craft harmonious Dofus outfits.",
    "header.themeMenuLabel": "Change theme",
    "header.languageMenuLabel": "Change language",
    "header.themeMenuTitle": "Theme",
    "header.languageMenuTitle": "Language",
  ...
  es: {
    "brand.tagline": "La paleta inteligente para imaginar tus atuendos de Dofus.",
    "meta.description":
      "KrosPalette extrae los colores dominantes de tus imágenes para crear conjuntos de Dofus armoniosos.",
    "header.themeMenuLabel": "Cambiar tema",
    "header.languageMenuLabel": "Cambiar idioma",
    "header.themeMenuTitle": "Tema",
    "header.languageMenuTitle": "Idioma",
    "navigation.primary": "Navegación principal",
    "navigation.workspace": "Taller",
    "navigation.palette": "Paleta",
  ...
  de: {
    "brand.tagline": "Die intelligente Palette für deine Dofus-Looks.",
    "meta.description":
      "KrosPalette extrahiert die dominanten Farben deiner Bilder und erstellt harmonische Dofus-Outfits.",
    "header.themeMenuLabel": "Thema ändern",
    "header.languageMenuLabel": "Sprache wechseln",
    "header.themeMenuTitle": "Thema",
    "header.languageMenuTitle": "Sprache",
    "navigation.primary": "Hauptnavigation",
    "navigation.workspace": "Arbeitsbereich",
    "navigation.palette": "Palette",
  ...
  pt: {
    "brand.tagline": "A paleta inteligente para imaginar seus visuais de Dofus.",
    "meta.description":
      "KrosPalette extrai as cores dominantes das suas imagens para criar visuais harmoniosos de Dofus.",
    "header.themeMenuLabel": "Alterar tema",
    "header.languageMenuLabel": "Alterar idioma",
    "header.themeMenuTitle": "Tema",
    "header.languageMenuTitle": "Idioma",
    "navigation.primary": "Navegação principal",
    "navigation.workspace": "Ateliê",
    "navigation.palette": "Paleta",
    "navigation.suggestions": "Sugestões",
