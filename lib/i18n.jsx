...
const TRANSLATIONS = {
  fr: {
    ...
    "navigation.analyzer": "Analyse & suggestions",
    "navigation.gallery": "Galerie",
    "gallery.title": "Galerie de skins",
    "gallery.lead":
      "Parcourez des looks générés automatiquement avec le même moteur que les suggestions et trouvez l'inspiration.",
    "gallery.loading": "Chargement des skins…",
    "gallery.close": "Fermer la fiche",
    "gallery.placeholder.subtitle": "Aperçu en préparation",
    "gallery.entryTitle": "{className} · Look #{index}",
    "gallery.gender.male": "Homme",
    "gallery.gender.female": "Femme",
    "gallery.direction.label": "Orientation du rendu",
    "gallery.itemsTitle": "Équipements sélectionnés",
    "gallery.actions.download": "Télécharger l'aperçu",
    "gallery.actions.barbofus": "Ouvrir dans Barbofus",
    "gallery.actions.souff": "Afficher sur Souff",
    "gallery.actions.copy": "Copier l'aperçu",
    "gallery.actions.share": "Partager le skin",
    "gallery.actions.unavailable": "Indisponible",
    ...
    "suggestions.render.copySkin": "Copier le skin",
    "suggestions.render.copySkinUnavailable": "Copie du skin indisponible",
    "suggestions.render.share": "Partager le lien du skin",
    "suggestions.render.shareUnavailable": "Lien du skin indisponible",
  ...
  en: {
    ...
    "navigation.analyzer": "Analyzer",
    "navigation.gallery": "Gallery",
    "gallery.title": "Skin gallery",
    "gallery.lead":
      "Browse automatically generated looks powered by the same engine as the suggestion page.",
    "gallery.loading": "Loading skins…",
    "gallery.close": "Close details",
    "gallery.placeholder.subtitle": "Live preview coming soon",
    "gallery.entryTitle": "{className} · Look #{index}",
    "gallery.gender.male": "Male",
    "gallery.gender.female": "Female",
    "gallery.direction.label": "Preview orientation",
    "gallery.itemsTitle": "Selected equipment",
    "gallery.actions.download": "Download preview",
    "gallery.actions.barbofus": "Open in Barbofus",
    "gallery.actions.souff": "View on Souff",
    "gallery.actions.copy": "Copy preview",
    "gallery.actions.share": "Share this skin",
    "gallery.actions.unavailable": "Unavailable",
    ...
    "suggestions.render.copySkin": "Copy skin image",
    "suggestions.render.copySkinUnavailable": "Skin copy unavailable",
    "suggestions.render.share": "Share skin link",
    "suggestions.render.shareUnavailable": "Skin link unavailable",
  ...
  es: {
    ...
    "navigation.analyzer": "Analizador",
    "navigation.gallery": "Galería",
    "gallery.title": "Galería de skins",
    "gallery.lead":
      "Explora combinaciones generadas automáticamente con el mismo motor que la página de sugerencias.",
    "gallery.loading": "Cargando skins…",
    "gallery.close": "Cerrar ficha",
    "gallery.placeholder.subtitle": "Vista previa en preparación",
    "gallery.entryTitle": "{className} · Look #{index}",
    "gallery.gender.male": "Masculino",
    "gallery.gender.female": "Femenino",
    "gallery.direction.label": "Orientación del render",
    "gallery.itemsTitle": "Equipamiento seleccionado",
    "gallery.actions.download": "Descargar vista previa",
    "gallery.actions.barbofus": "Abrir en Barbofus",
    "gallery.actions.souff": "Ver en Souff",
    "gallery.actions.copy": "Copiar vista previa",
    "gallery.actions.share": "Compartir skin",
    "gallery.actions.unavailable": "No disponible",
    ...
    "suggestions.render.copySkin": "Copiar imagen del skin",
    "suggestions.render.copySkinUnavailable": "Copia del skin no disponible",
    "suggestions.render.share": "Compartir enlace del skin",
    "suggestions.render.shareUnavailable": "Enlace del skin no disponible",
  ...
  de: {
    ...
    "navigation.analyzer": "Analyse",
    "navigation.gallery": "Galerie",
    "gallery.title": "Skin-Galerie",
    "gallery.lead":
      "Entdecke automatisch generierte Kombinationen – erstellt mit derselben Engine wie die Vorschläge.",
    "gallery.loading": "Skins werden geladen…",
    "gallery.close": "Karte schließen",
    "gallery.placeholder.subtitle": "Vorschau in Vorbereitung",
    "gallery.entryTitle": "{className} · Look #{index}",
    "gallery.gender.male": "Männlich",
    "gallery.gender.female": "Weiblich",
    "gallery.direction.label": "Ausrichtung der Vorschau",
    "gallery.itemsTitle": "Ausgewählte Ausrüstung",
    "gallery.actions.download": "Vorschau herunterladen",
    "gallery.actions.barbofus": "In Barbofus öffnen",
    "gallery.actions.souff": "Auf Souff anzeigen",
    "gallery.actions.copy": "Vorschau kopieren",
    "gallery.actions.share": "Skin teilen",
    "gallery.actions.unavailable": "Nicht verfügbar",
    ...
    "suggestions.render.copySkin": "Skin-Bild kopieren",
    "suggestions.render.copySkinUnavailable": "Skinkopie nicht verfügbar",
    "suggestions.render.share": "Skin-Link teilen",
    "suggestions.render.shareUnavailable": "Skin-Link nicht verfügbar",
  ...
  pt: {
    ...
    "navigation.analyzer": "Analisador",
    "navigation.gallery": "Galeria",
    "gallery.title": "Galeria de skins",
    "gallery.lead":
      "Explore combinações geradas automaticamente com o mesmo motor da página de sugestões.",
    "gallery.loading": "Carregando skins…",
    "gallery.close": "Fechar ficha",
    "gallery.placeholder.subtitle": "Prévia em preparação",
    "gallery.entryTitle": "{className} · Look #{index}",
    "gallery.gender.male": "Masculino",
    "gallery.gender.female": "Feminino",
    "gallery.direction.label": "Orientação da prévia",
    "gallery.itemsTitle": "Equipamentos selecionados",
    "gallery.actions.download": "Baixar prévia",
    "gallery.actions.barbofus": "Abrir no Barbofus",
    "gallery.actions.souff": "Ver no Souff",
    "gallery.actions.copy": "Copiar prévia",
    "gallery.actions.share": "Compartilhar skin",
    "gallery.actions.unavailable": "Indisponível",
    ...
    "suggestions.render.copySkin": "Copiar imagem do skin",
    "suggestions.render.copySkinUnavailable": "Cópia do skin indisponível",
    "suggestions.render.share": "Compartilhar link do skin",
    "suggestions.render.shareUnavailable": "Link do skin indisponível",
