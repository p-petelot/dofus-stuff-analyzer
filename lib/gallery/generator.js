...
export async function generateGallerySkins({
  ...
  for (let index = 0; index < total; index += 1) {
    ...
    const anchor = pickAnchorItem(recoloredItems, paletteNumeric.hex);
    ...
    const initialItems = chooseItemsForPalette(selectionPalette.hex, recoloredItems, { anchor });
    ...
    const selectedItems = chooseItemsForPalette(aggregatedPalette.hex, recoloredItems, { anchor, preferred });
