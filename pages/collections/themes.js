...
const DEFAULT_PAGE_CONFIG = {
  ...
  pageDescription:
    "Choisissez une couleur comme sur la page principale et explorez une large sélection de skins aux classes et sexes aléatoires.",
  eyebrow: "Collection Thèmes",
  heroTitle: "Collection Thèmes",
  heroDescription:
    "Retrouvez l'expérience de la page d'accueil : sélectionnez une teinte, laissez l'algorithme varier la classe et le sexe, puis parcourez un maximum d'inspirations à partir de votre couleur.",
  colorLabel: "Couleur",
...
export default function ThemesCollectionsPage() {
