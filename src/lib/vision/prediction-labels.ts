export type PredictionLabels = ReturnType<typeof buildPredictionLabels>;

export function buildPredictionLabels(t: (key: string, params?: Record<string, unknown>, fallback?: string) => unknown) {
