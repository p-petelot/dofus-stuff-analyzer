...
const TRANSLATIONS = {
  fr: {
    ...
    "vision.lab.subtitle":
      "Génère des sprites, entraîne le modèle et valide les prédictions directement depuis KrosPalette.",
    ...
    "suggestions.render.recap": "Exporter l'image récap",
    "suggestions.render.recapUnavailable": "Export récap indisponible",
  ...
  en: {
    ...
    "vision.lab.subtitle":
      "Generate sprites, train the model and validate predictions without leaving KrosPalette.",
    ...
    "suggestions.render.recap": "Export recap image",
    "suggestions.render.recapUnavailable": "Recap export unavailable",
  ...
  es: {
    ...
    "vision.lab.subtitle":
      "Genera sprites, entrena el modelo y valida las predicciones sin salir de KrosPalette.",
    ...
    "suggestions.render.recap": "Exportar imagen de resumen",
    "suggestions.render.recapUnavailable": "Exportación de resumen no disponible",
  ...
  de: {
    ...
    "vision.lab.subtitle":
      "Erzeuge Sprites, trainiere das Modell und prüfe Vorhersagen direkt in KrosPalette.",
    ...
    "suggestions.render.recap": "Recap-Bild exportieren",
    "suggestions.render.recapUnavailable": "Recap-Export nicht verfügbar",
  ...
  pt: {
    ...
    "vision.lab.subtitle":
      "Gere sprites, treine o modelo e valide previsões sem sair da KrosPalette.",
    ...
    "suggestions.render.recap": "Exportar imagem de resumo",
    "suggestions.render.recapUnavailable": "Exportação do resumo indisponível",
...
function resolveInitialLanguage(initialLanguage) {
  const provided = normalizeLanguage(initialLanguage);
  if (provided) {
    return provided;
  }
...
export const useLanguageStore = defineStore("language", () => {
  ...
  const languages = computed(() => buildLanguageOptions());
  ...
  const t = (key, params, fallback) => translateInternal(language.value, key, params, fallback);

  onMounted(() => {
    const resolved = resolveInitialLanguage(language.value);
    if (resolved && resolved !== language.value) {
